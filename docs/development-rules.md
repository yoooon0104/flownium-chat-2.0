...
8. 큰 기능 방향이 바뀌면 `docs/wbs.md`와 설계 문서를 함께 갱신한다.
...
3. API/Socket 스펙 변경이 있으면 `docs/api-spec.md`, `docs/socket-events.md`를 같은 작업에서 갱신한다.
4. 인증/환경변수 변경이 있으면 `.env` 키 목록과 `docs/architecture.md`를 함께 점검한다.
